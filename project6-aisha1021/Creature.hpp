...
/* 
    ...
    Each type of creature will have their own attacks. The type and damage of each attack will be based on the 
    Creature's category. Furthermore, each attack may consist of multiple type of attacks with corresponding 
    damage. For example, a MYSTICAL dragon with FIRE element may have a BITE attack that consists of a PHYSICAL 
    attack with damage 4 and a FIRE attack with damage 1. Such attack would be as follows:
...
class Creature
{
    public:
        ...
        */        
         ...
         */
        virtual void addAttack(const int& attack_index) = 0;
