...
/* The Ingredient struct should consist of the following data members
...
struct Ingredient {
    ...
    */
    Ingredient(const std::string& name, const std::string& description, int quantity, int price, const std::vector<Ingredient*>& recipe) // const Recipe& recipe
...
public:
    ...
    */
    int getPosOf(const std::string& ingredientName) const;

    /**
        @param: A const string reference to a ingredient name
        @return: True if the ingredient information is already in the Pantry
    */
    bool contains(const std::string& ingredientName) const;
    ...
    */
    void ingredientQuery(const std::string& ingredientName) const;
    ...
    */
    void printRecipe(Ingredient* ingredient) const;
